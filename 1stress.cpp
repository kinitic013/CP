...
{
    testcase randomTest;
    ll n = randomNumber(1, 6);
    randomTest.n = n;
    REP(i,0,n)
    {
        ll l = randomNumber(1,10);
        ll r = randomNumber(l,5);
        randomTest.arr.push_back({l,r});
    }
    debug(randomTest.n,randomTest.arr);
    return randomTest;
}
