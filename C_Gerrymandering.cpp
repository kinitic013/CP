...
ll check_config_2(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx= 3*i;
    ...
    ll count = arr[0][idx-1] + arr[1][idx-1] + arr[1][idx-2];
    if(count>=2)
    return 1;
    else
    return 0;
}
ll check_config_1(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx = 3*i;
    ...
    ll count = arr[1][idx-1] + arr[0][idx-1] + arr[0][idx-2];
    if(count>=2)
    return 1;
    else
    return 0;
}
ll check_config_3(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx = 3*i;
    ...
    ll count1 = arr[0][idx-3] + arr[0][idx-4] + arr[0][idx-5];
    if(count1>=2) count1 = 1;
    else count1 = 0;

    ll count2 = arr[1][idx-2] + arr[1][idx-3] + arr[1][idx-4]; 
    if(count2>=2) count2 = 1;
    else count2 = 0;

    return count1+count2;
}
ll check_config_6(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx = 3*i;
    ...
    ll count1 = arr[1][idx-3] + arr[1][idx-4] + arr[1][idx-5];
    if(count1>=2) count1 = 1;
    else count1 = 0;

    ll count2 = arr[0][idx-2] + arr[0][idx-3] + arr[0][idx-4]; 
    if(count2>=2) count2 = 1;
    else count2 = 0;

    return count1+count2;
}
ll check_config_4(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx = 3*i;
    ...
    ll count = arr[0][idx-3] + arr[1][idx-3] + arr[1][idx-2];
    if(count>=2)
    return 1;
    else
    return 0;
...
ll check_config_5(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx = 3*i;
    ...
    ll count = arr[1][idx-3] + arr[0][idx-3] + arr[0][idx-2];
    if(count>=2)
    return 1;
    else
    return 0;
}
ll check_config_7(vvi& arr,ll i,ll n)
{
    ll m = n/3;
    ll idx = 3*i;
    ...
    ll count1 = arr[1][idx-1] + arr[1][idx-2] + arr[1][idx-3];
    if(count1>=2) count1 = 1;
    else count1 = 0;

    ll count2 = arr[0][idx-1] + arr[0][idx-2] + arr[0][idx-3]; 
    if(count2>=2) count2 = 1;
    else count2 = 0;
...
void solve(ll t)
{
    ...
    REP(i,1,m+1)
    {
        ...
        // for j=1
        {
            dp[i][1] = max(dp[i][1] , dp[i-1][0] + check_config_5(arr,i,n));
            dp[i][1] = max(dp[i][1] , dp[i-1][1] + check_config_6(arr,i,n));
        }
        // for j = 2
        {
            dp[i][2] = max(dp[i][2] , dp[i-1][0] + check_config_4(arr,i,n));
            dp[i][2] = max(dp[i][2] , dp[i-1][2] + check_config_3(arr,i,n));
        }
        // for j=0
        {
            dp[i][0] = max(dp[i][0] , dp[i][1] + check_config_2(arr,i,n));
            dp[i][0] = max(dp[i][0] , dp[i][2] + check_config_1(arr,i,n));
            dp[i][0] = max(dp[i][0] , dp[i-1][0] + check_config_7(arr,i,n));
        }
        debug(dp[i]);
    }
    cout<<dp[m][0];
