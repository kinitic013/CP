...
void solve(vi& p)
{
    ...
    while(i<n && j<n)
    {
        ...
        if(sum >= need)
        {
            ...
            else if(right_c >= need && left_bob>=need)
            {
                cout<<i+1<<" "<<j+1<<" ";
                cout<<1<<" "<<i<<" ";
                cout<<j+2<<" "<<n<<" ";
    ...
    while(i<n && j<n)
    {
        ...
        if(sum >= need)
        {
            ...
            right_alice = A[n-1] - A[j];
            right_c = C[n-1] - C[j];

            if(right_alice >= need && left_c>=need)
            {
                cout<<j+2<<" "<<n<<" ";
                cout<<i+1<<" "<<j+1<<" ";
                cout<<1<<" "<<i<<" ";
            ...
            else if(right_c >= need && left_alice>=need)
            {
                cout<<1<<" "<<i<<" ";
                cout<<i+1<<" "<<j+1<<" ";
                cout<<j+2<<" "<<n<<" ";
    ...
    while(i<n && j<n)
    {
        ...
        if(sum >= need)
        {
            ...
            if(right_alice >= need && left_bob>=need)
            {
                cout<<j+2<<" "<<n<<" ";
                cout<<1<<" "<<i<<" ";
                cout<<i+1<<" "<<j+1<<" ";
            ...
            else if(right_bob >= need && left_alice>=need)
            {
                cout<<1<<" "<<i<<" ";
                cout<<j+2<<" "<<n<<" ";
                cout<<i+1<<" "<<j+1<<" ";
