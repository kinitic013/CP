...
void solve(vi& p)
{
    ...
    while(i<=j)
    {
        if(lastSmall)// looking to take jth video
        {
            if( m - curr < arr[j]) // we wait 1 min to watch then go
            {    
                ans++;
                curr = 0;
                lastSmall = true;
        ...
        else // looking to choose ith video
        {
            if( m - curr < arr[i]) // we wait 1 min to watch then go
            {    
                ans++;
                curr = 0;
                lastSmall = true;
