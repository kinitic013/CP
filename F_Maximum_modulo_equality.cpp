...
void build(vector<int>& arr, int start , int end , int index)
{
    ...
    // if(segTree[left] == INT_MAX && segTree[right] == INT_MAX)
    // segTree[index] = INT_MAX;
    // else if(segTree[left] == INT_MAX)
    // segTree[index] = segTree[right];
    // else if(segTree[right] == INT_MAX)
    // segTree[index] =  segTree[left];
    // else
    segTree[index] =  __gcd(segTree[left],segTree[right]);
}
int query(int start,int end , int index , int l , int r)
{
    ...
    {
        int leftValue = query(start,mid,left,l,r);
        int rightValue = query(mid+1,end,right,l,r);
        ...
        // return left;
        // else
        return __gcd(leftValue,rightValue);
    }
    return 0;
}
void solve(ll t)
