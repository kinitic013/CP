...
{
    ll n,m;cin>>n>>m;
    pdd l1a,l1b,l2a,l2b,l3a,l3b,l4a,l4b;
    ll distA,distB,distC,distD;
    pdd inf = make_pair(FLT_MAX, FLT_MAX);
    //top left (1,1)
    cout<<"? 1 1"<<endl;
    cout.flush();
    cin>>distA;
    ...
    pdd point1 = lineLineIntersection(l1a,l1b,l3a,l3b);
    pdd point2 = lineLineIntersection(l2a,l2b,l3a,l3b);
    if(point1 != inf)
    {
        //check point1
        cout<<"? "<<point1.ff<<" "<<point1.ss<<endl;
        cout.flush();
        ll dist;
        cin>>dist;
        if(dist == 0)
